...
function Footer() {
  ...
  return (
    <>
      ...
      <footer class=" bottom-0 left-0 z-20 w-full p-4 bg-white rounded-lg  border-t border-gray-200 shadow  md:items-center md:justify-between md:p-6 dark:bg-stone-950 dark:border-gray-600">
