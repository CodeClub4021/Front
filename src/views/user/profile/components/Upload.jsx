...
const Upload = () => {
  ...
  return (
    <Card className="shadow-3xl shadow-shadow-500 dark:!bg-navy-800 grid h-full w-full grid-cols-1 gap-3 rounded-[20px] bg-yellow-300 bg-clip-border p-3 font-dm dark:shadow-none 2xl:grid-cols-11">
      <div className="bg-lightPrimary  dark:!bg-navy-700 col-span-5 rounded-xl 2xl:col-span-12">
        <button
          className="dark:!border-navy-700 flex h-full w-full flex-col items-center justify-center rounded-xl border-[2px] border-dashed border-gray-200 py-3 lg:pb-0"
