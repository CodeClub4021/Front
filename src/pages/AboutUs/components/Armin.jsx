...
import avatar from "../../../assets/img/avatars/Armin.jpg";
...
const iconsTab = [
    { icon: <FaTelegramPlane />, url: "https://t.me/Armin_40" },
    { icon: <FaGithub />, url: "https://github.com/armin40behrouzi81" },
    { icon: <FaLinkedinIn />, url: "https://linkedin.com/in/armin40" },
];
