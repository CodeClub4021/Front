...
const iconsTab = [
    { icon: <FaTelegramPlane />, url: "https://t.me/AylinNaebzadeh" },
    { icon: <FaGithub />, url: "https://github.com/AylinNaebzadeh" },
    { icon: <FaLinkedinIn />, url: "https://linkedin.com/in/AylinNaebzadeh" },
];
  ...
  return (
    <Card extra={"items-center w-full h-full p-[16px] bg-cover"}>
      ...
      <div className="mt-14 mb-4 flex flex-col items-center">
        ...
        <p className="text-xl font-normal text-gray-900">scrum master</p>
      </div>
