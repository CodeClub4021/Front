...
import avatar from "../../../assets/img/avatars/AA.jpg";
...
const iconsTab = [
    { icon: <FaTelegramPlane />, url: "https://t.me/AkhbariAli" },
    { icon: <FaGithub />, url: "https://github.com/hajaliakh" },
    { icon: <FaLinkedinIn />, url: "https://linkedin.com/in/AkhbariAli" },
];
