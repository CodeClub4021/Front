...
import avatar from "../../../assets/img/avatars/AB.jpg";
...
const iconsTab = [
    { icon: <FaTelegramPlane />, url: "https://t.me/aibgr" },
    { icon: <FaGithub />, url: "https://github.com/aibgr" },
    { icon: <FaLinkedinIn />, url: "https://linkedin.com/in/aibgr" },
];
