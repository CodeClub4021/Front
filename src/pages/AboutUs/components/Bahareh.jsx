...
const iconsTab = [
    { icon: <FaTelegramPlane />, url: "https://t.me/Bahareh_0281" },
    { icon: <FaGithub />, url: "https://github.com/Bahareh0281" },
    { icon: <FaLinkedinIn />, url: "https://linkedin.com/in/Bahareh0281" },
];
  ...
  return (
    <Card extra={"items-center w-full h-full p-[16px] bg-cover"}>
      ...
      <div className="mt-14 mb-4 flex flex-col items-center">
        ...
        <p className="text-xl font-normal text-gray-900">product owner</p>
      </div>
