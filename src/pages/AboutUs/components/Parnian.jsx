...
import avatar from "../../../assets/img/avatars/Parnian.jpg";
...
const iconsTab = [
    { icon: <FaTelegramPlane />, url: "https://t.me/P81SH" },
    { icon: <FaGithub />, url: "https://github.com/parnian81" },
    { icon: <FaLinkedinIn />, url: "https://linkedin.com/in/parnian81" },
];
