...
import avatar from "../../../assets/img/avatars/sayin.jpg";
...
const iconsTab = [
    { icon: <FaTelegramPlane />, url: "https://t.me/Sayin81mit" },
    { icon: <FaGithub />, url: "https://github.com/SayinAla81" },
    { icon: <FaLinkedinIn />, url: "https://linkedin.com/in/SayinAla" },
];
  ...
  return (
    <Card extra={"items-center w-full h-full p-[16px] bg-cover"}>
      ...
      <div className="mt-14 mb-4 flex flex-col items-center">
        ...
        <p className="text-xl font-normal text-gray-900">backend developer</p>
      </div>
