        ...
        <div className="left-h">
          ...
          <div className="hero-text">
            ...
            <div>
              {data[0]?.desc ? (
                ...
                <span>gym description goes here...</span>
              )}
            </div>
          </div>
          {/* gender and date  */}
          <div className="font-md flex grid min-h-[100px] w-full grid-cols-4 text-white">
            ...
            <div className="flex items-center gap-2">
              <span>Since :</span>
              {data[0]?.sinc ? (
                <span>{data[0]?.sinc}</span>
              ) : (
                <span className="">Sinc</span>
              )}
            </div>
          </div>
          ...
          <div className="figures">
            <div>
              ...
              <span>coaches count</span>
            </div>
            <div>
              {data[0] ? (
                <span>
                  <NumberCounter
                    end={data[0]?.customer_count}
                    start={0}
                    delay={4}
                    preFix="+"
                  />
