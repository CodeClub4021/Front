...
const NavbarComponent = ({isLogin, isInPanel}) => {
    ...
    return (
        <nav
            className="text-gray text-[3vh]! fixed top-0 left-0 w-full z-[49] h-fit bg-gradient-to-br from-gray-900 from-40% via-gray-600 via-85% to-gray-300 py-2 text-lg"
        >
